...
```{r}
shan_sf <- st_read(dsn = "chap05/data/geospatial", 
...
```{r}
ict <- read_csv ("chap05/data/aspatial/Shan-ICT.csv")
```
...
write_rds(shan_sf, "chap05/data/rds/shan_sf.rds")
```
...
```{r}
shan_sf <- read_rds("chap05/data/rds/shan_sf.rds")
```
...
#| eval: false
#| echo: false
write_rds(shan_ict, "shan_ict.rds")
```
