...
```{r}
#| eval: false
pop <- read_csv("chap15/data/aspatial/pop.csv")
```
...
```{r}
#| eval: false
write_rds(flow_data1, "chap15/data/rds/SIM_data")
```
...
```{r}
SIM_data <- read_rds("chap15/data/rds/SIM_data.rds")
```
