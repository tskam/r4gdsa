...
In this hands-on exercise, you will learn how to build an OD matrix by using [*Passenger Volume by Origin Destination Bus Stops*]() data set downloaded from [LTA DataMall](https://datamall.lta.gov.sg/content/datamall/en.html). By the end of this hands-on exercise, you will be able:
...
renderthis::to_pdf(from = "https://r4gdsa.netlify.app/chap02.html",
                   to = "D://ISSS624_AY2023-24Dec/03-Hands-on_Ex/Hands-on_Ex1b.pdf")
```
