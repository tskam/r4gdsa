...
Next, code chunk below will be used to exclude all outer island from the data set.
...
It is always a good habit to write to clean dataset into a rds file format for future use.
...
```{r}
#| echo: false
write_rds(childcare_sf, 
          "chap04/data/childcare_sf.rds")
```
